...
**`Deckhand.html`** — the current release (v7.1; the name is version-free since 7.0, `Deckhand_v6.html` forwards to it). Everything — HTML, CSS, JS — lives
...
`tests/` — a Playwright suite (`@playwright/test`), 182 tests split by feature, each in
